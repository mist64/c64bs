9000 ;*********************************
9010 ; RUECKENTWICKLUNG AUS BS 1.32
9030 ; NUR F-TASTEN, SERIELL PER ACIA
9040 ; $%&-WERTE, @-DISK-BEFEHLE
9050 ; KEINE KASSETTE AUS PLATZGRUENDEN
9060 ; DAFUER KEINE FEHLER....
9070 ; SPEZIELL FUER M.HETTENBACH
9080 ; WEIL ER KEINEN PAR. IEC-BUS HAT
9090 ;*********************************
...
21190 ;-------- RESET
21200 NRESET JSR FRESET:RSRESET STA ACIA+1:RTS
21220 ;-------- BASIN
...
25200 *=$F72C
25205 NINI STA $DC00
25210 IECINI LDA C2:AND # 239:STA C2
